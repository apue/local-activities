...
operator-created local jobs or Sandbox failures marked fallback-eligible, as
defined in [Local Collector Console And Job Queue Spec](local-collector-console.md).
